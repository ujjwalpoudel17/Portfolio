    ...
    <>
      <main className="container mx-auto  overflow-hidden">
        ...
        >
          ...
          <p className='mb-10'>Here are some of the projects that showcase my skills in web development, demonstrating my ability to build responsive, accessible, and modern applications using various technologies.</p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white  p-10 rounded-lg shadow-xl hover:shadow-lg transition-shadow duration-300 transform hover:scale-105 transition-transform">
            ...
            <div className="bg-white d p-10 rounded-lg shadow-xl hover:shadow-lg transition-shadow duration-300 transform hover:scale-105 transition-transform">
